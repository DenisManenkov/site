...
exports.ImageBlock = exports.ColumsBlock = exports.TextBlock = exports.TitleBlock = void 0;
...
var ColumsBlock = /*#__PURE__*/function (_Block3) {
  _inherits(ColumsBlock, _Block3);

  var _super3 = _createSuper(ColumsBlock);
...
var ImageBlock = /*#__PURE__*/function (_Block4) {
  ...
  _createClass(ImageBlock, [{
    ...
    value: function toHTML() {
      ...
      return (0, _utils.row)("<img src=\"".concat(this.value, "\" style=\"").concat((0, _utils.css)(is), "\" />"), (0, _utils.css)(styles));
    }
  }]);
...
var model = [new _blocks.TitleBlock("Hello World from JS45", {
  tag: "h2",
...
}), new _blocks.ColumsBlock(["1111111111", "2222222222", "33333333333", "46584948654"], {
  styles: {
...
new _app.App(_model.model).init(); // model.forEach((block) => {
//   site.insertAdjacentHTML("beforeend", block.toHTML());
// });
},{"./model.js":"model.js","./styles/main.css":"styles/main.css","./classes/app.js":"classes/app.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
